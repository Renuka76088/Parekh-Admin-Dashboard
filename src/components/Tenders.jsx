    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in-up">
      ...
      {showModal && createPortal(
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center p-4 md:p-8 lg:p-12">
          ...
          <div className="relative w-full max-w-4xl bg-white rounded-[2.5rem] shadow-[0_32px_64px_-15px_rgba(0,0,0,0.3)] border border-white/20 flex flex-col animate-scale-in max-h-[90vh]">
