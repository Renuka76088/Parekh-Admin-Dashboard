                ...
                <div key={blog._id} className="premium-card overflow-hidden group flex flex-col sm:flex-row">
                    <div className="w-full sm:w-64 shrink-0 bg-slate-100 overflow-hidden relative border-b sm:border-b-0 sm:border-r border-slate-100">
                        ...
                        <div className="absolute top-4 left-4">
                            <span className={`text-[10px] font-black px-2 py-1 rounded-md uppercase tracking-widest border border-white/20 backdrop-blur-md ${
                                blog.status === 'published' ? 'bg-emerald-500/80 text-white' : 'bg-slate-900/80 text-white'
                            }`}>
                                {blog.status}
                            </span>
                        </div>
                        ...
                        <div className="flex gap-4 p-2 bg-slate-100 rounded-2xl border border-slate-200">
                             <button
                                ...
                                className={`flex-1 py-2 text-xs font-black uppercase tracking-widest rounded-xl transition-all ${
                                    formData.status === 'draft' ? 'bg-white text-indigo-700 shadow-sm' : 'text-slate-400 hover:text-slate-600'
                                }`}
                             >
                                 Draft
                             </button>
                             <button
                                ...
                                className={`flex-1 py-2 text-xs font-black uppercase tracking-widest rounded-xl transition-all ${
                                    formData.status === 'published' ? 'bg-indigo-600 text-white shadow-lg' : 'text-slate-400 hover:text-slate-600'
                                }`}
                             >
                                 Published
                             </button>
